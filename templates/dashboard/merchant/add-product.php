        ...
        <div class="section pt-2">
            <div class="wallet-card">
                ...
                <div class="action-sheet-content">
                    <form action="/merchants/<?= $ProductInfo->id ?>/sellitem" method="POST" enctype="multipart/form-data" autocomplete="off">
                        <?= $Self->tokenize() ?>
                        ...
                        <div class="form-group basic mt-3">
                            ...
                            <div class="input-group mb-2">
                                <input class="form-control form-control-lg xProductTitle" type="text" name="title" id="title" maxlength="<?= product_title_count ?>" placeholder="Product Title/Name" value="<?= $ProductInfo->name ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group basic">
                            ...
                            <div class="input-group mb-2">
                                <textarea class="form-control form-control-lg xProductDescription" name="description" id="description" maxlength="<?= product_description_count ?>" placeholder="Product Description"><?= $ProductInfo->description ?></textarea>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-sm-6 col-xs-2 col-lg-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control form-control-lg" name="bulkprice" placeholder="0" value="<?= $ProductInfo->bulkprice ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-sm-6 col-xs-2 col-lg-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control form-control-lg" name="retailprice" placeholder="0" value="<?= $ProductInfo->retailprice ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3 col-sm-6 col-xs-6 col-lg-3 mb-2">
                                    <div class="custom-file-upload" id="custom-file-upload-1">
                                        ...
                                        <label for="productphotos1" style="background-image: url(<?= $Photos[0]  ?>);no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
                                            <span>
                                                <strong>
                                ...
                                <div class="col-6 col-md-3 col-sm-6 col-xs-6 col-lg-3 mb-2">
                                    <div class="custom-file-upload" id="custom-file-upload-2">
                                        ...
                                        <label for="productphotos2" style="background-image: url(<?= $Photos[1]  ?>);no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
                                            <span>
                                                <strong>
                                ...
                                <div class="col-6 col-md-3 col-sm-6 col-xs-6 col-lg-3">
                                    <div class="custom-file-upload" id="custom-file-upload-3">
                                        ...
                                        <label for="productphotos3" style="background-image: url(<?= $Photos[2]  ?>);no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
                                            <span>
                                                <strong>
                                ...
                                <div class="col-6 col-md-3 col-sm-6 col-xs-6 col-lg-3">
                                    <div class="custom-file-upload" id="custom-file-upload-4">
                                        ...
                                        <label for="productphotos4" style="background-image: url(<?= $Photos[3]  ?>);no-repeat center center fixed; -webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
                                            <span>
                                                <strong>
