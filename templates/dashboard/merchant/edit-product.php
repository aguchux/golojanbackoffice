                ...
                <div class="action-sheet-content">
                    <form action="/merchants/<?= $ProductInfo->id ?>/edititem" method="POST" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group basic">
                            <div class="row">
                                <div class="col-12 col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    ...
                                    <textarea class="form-control form-control-lg xProductDescription" style="width: 100%;" required aria-required="true" name="description" id="description" maxlength="<?= product_description_count ?>" placeholder="Product Short Description"><?= $ProductInfo->description ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group basic">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12 col-sm-12 col-xs-12 col-lg-12">
                                    <label class="h5" for="long_description">Long Description</label>
                                    <textarea class="form-control form-control-lg longsummernote" style="width: 100%;" required aria-required="true" name="long_description" id="long_description" placeholder="Long Description"><?= $ProductInfo->long_description ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-sm-6 col-xs-2 col-lg-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control form-control-lg" required aria-required="true" id="suplier_sku" name="suplier_sku" value="<?= $ProductInfo->suplier_sku ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-sm-6 col-xs-2 col-lg-6">
                                    ...
                                    <div class="input-group mb-2">
                                        <select class="form-control form-control-lg" required aria-required="true" name="product_type" id="product_type">
                                            ...
                                            <option <?= $ProductInfo->product_type == "physical" ? 'selected' : '' ?> value="physical">Physical</option>
                                            <option <?= $ProductInfo->product_type == "digital" ? 'selected' : '' ?> value="digital">Digital (Downloadable)</option>
                                            <option <?= $ProductInfo->product_type == "services" ? 'selected' : '' ?> value="services">Services/Artisans</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-sm-6 col-xs-2 col-lg-6">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="number" class="form-control form-control-lg" required aria-required="true" id="product_weight" name="product_weight" placeholder="0" step="0.1" min="0" max="1000" value="<?= $ProductInfo->product_weight ?>">
                                    </div>
                                </div>
