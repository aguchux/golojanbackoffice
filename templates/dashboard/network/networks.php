<div class="section mt-3 text-center">
    <div class="avatar-section FlashGlow_<?= $UserInfo->accid ?>">
        <a href="javascript:;" class="btn-link">
            <img src="<?= $UserInfo->avatar ?>" alt="<?= $UserInfo->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $UserInfo->accid ?>" data-sponsor="<?= $UserInfo->sponsor ?>"><br /><?= "{$UserInfo->fullname}<br/>({$UserInfo->accid})" ?>
        </a>
    </div>
</div>
            ...
            <?php foreach ($Level1 as $level1) : $L1U = $Core->UserInfo($level1); ?>
                ...
                <div class="col-6">
                    <div class="avatar-section">
                        <a href="javascript:;" class="btn-link">
                            <img src="<?= $L1U->avatar ?>" alt="<?= $L1U->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $L1U->accid ?>" data-sponsor="<?= $L1U->sponsor ?>"><br /><?= "{$L1U->fullname}<br/>({$L1U->accid})" ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <?php foreach ($Level2 as $level2) : $L2U = $Core->UserInfo($level2); ?>
                ...
                <div class="col-3">
                    <div class="avatar-section">
                        <a href="javascript:;" class="btn-link">
                            <img src="<?= $L2U->avatar ?>" alt="<?= $L2U->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $L2U->accid ?>" data-sponsor="<?= $L2U->sponsor ?>"><br /><?= "{$L2U->fullname}<br/>({$L2U->accid})" ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <?php foreach ($Level3 as $level3) : $L3U = $Core->UserInfo($level3); ?>
                ...
                <div class="col-3">
                    <div class="avatar-section">
                        <a href="javascript:;" class="btn-link">
                            <img src="<?= $L3U->avatar ?>" alt="<?= $L3U->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $L3U->accid ?>" data-sponsor="<?= $L3U->sponsor ?>"><br /><?= "{$L3U->fullname}<br/>({$L3U->accid})" ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <?php foreach ($Level5 as $level5) : $L5U = $Core->UserInfo($level5); ?>
                ...
                <div class="col-3 FlashGlow">
                    <div class="avatar-section">
                        <a href="javascript:;" class="btn-link">
                            <img src="<?= $L5U->avatar ?>" alt="<?= $L5U->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $L5U->accid ?>" data-sponsor="<?= $L5U->sponsor ?>"><br /><?= "{$L5U->fullname}<br/>({$L5U->accid})" ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <?php foreach ($Level6 as $level6) : $L6U = $Core->UserInfo($level6); ?>
                ...
                <div class="col-3 FlashGlow">
                    <div class="avatar-section">
                        <a href="javascript:;" class="btn-link">
                            <img src="<?= $L6U->avatar ?>" alt="<?= $L6U->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $L6U->accid ?>" data-sponsor="<?= $L6U->sponsor ?>"><br /><?= "{$L6U->fullname}<br/>({$L6U->accid})" ?>
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <?php foreach ($Level7 as $level7) : $L7U = $Core->UserInfo($level7); ?>
                ...
                <div class="col-3 FlashGlow">
                    <div class="avatar-section">
                        <a href="javascript:;" class="btn-link">
                            <img src="<?= $L7U->avatar ?>" alt="<?= $L7U->fullname ?>" class="imaged w100 rounded FlashGlow" id="<?= $L7U->accid ?>" data-sponsor="<?= $L7U->sponsor ?>"><br /><?= "{$L7U->fullname}<br/>({$L7U->accid})" ?>
                        </a>
                    </div>
                </div>
...
<div class="section mt-3 mb-5 text-center">
    <div class="card p-3">
